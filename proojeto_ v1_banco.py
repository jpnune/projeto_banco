...
#   Fomos contrados por um grande banco para desenvolver um novo sistema. Esse banco deseja modernizar suas operações e para isso
#   escolheu a linguaem Python. Para a primeira versão do sistema devemos implementar apenas 3 operações: depósito, saque e extrato.
...
#   dessa forma não precisamos nos preocupar qual o número da agência e conta bancária. Todos os depósitos devem ser armazenados
#   em uma variável e exibidos na operação de extrato.

#####################################################################################################################################
#   Operação de Saque

#   O sistema deve permitir realizar 3 saques diários com limites máximos de R$ 500,00 por saque. Caso o usuário nao tenha saldo
...
#   saques devem ser armazenado em uma variável e exibido da operação de extrato. 
...
#    para essa primeira parte do projeto eu assumi que o ususario vai ter que colocar alguns valores corretos se nao vai quebrar o código.
#    Ex: numero de casa de float foi arredondado somente na visualizaçao e na foi truncado, caso seja apertado enter nos input nao
